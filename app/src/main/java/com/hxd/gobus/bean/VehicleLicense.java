...
public class VehicleLicense {
     ...
     * fenceIds : string //备用字段1(电子围栏表主键ID集合) FENCE_IDS fenceIds
    ...
    public static VehicleLicense objectFromData(String str) {

        return new Gson().fromJson(str, VehicleLicense.class);
    }

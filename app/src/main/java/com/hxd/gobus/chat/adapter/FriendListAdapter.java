...
public class FriendListAdapter extends BaseAdapter implements com.hxd.gobus.chat.adapter.StickyListHeadersAdapter, SectionIndexer {
            ...
            JMessageClient.getUserInfo(entry.username, new GetUserInfoCallback() {
                ...
                public void gotResult(int i, String s, UserInfo userInfo) {
                    if (i==0) {
                        ...
                        holder.headAvatar.setImageResource(R.mipmap.jmui_head_icon);
                    }
                }
            });
        }

...
import com.hxd.gobus.chat.activity.SendFileActivity;
import com.hxd.gobus.chat.adapter.ViewPagerAdapter;
import com.hxd.gobus.chat.entity.FileType;
import com.hxd.gobus.chat.entity.UpdateSelectedStateListener;
import com.hxd.gobus.chat.activity.fragment.AudioFragment;
import com.hxd.gobus.chat.activity.fragment.DocumentFragment;
import com.hxd.gobus.chat.activity.fragment.ImageFragment;
import com.hxd.gobus.chat.activity.fragment.OtherFragment;
import com.hxd.gobus.chat.activity.fragment.VideoFragment;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(mContext.getSupportFragmentManger(), fragments);
        ...
        String targetId = mContext.getIntent().getStringExtra(BaseConfig.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(BaseConfig.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(BaseConfig.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(BaseConfig.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(BaseConfig.RESULT_CODE_SEND_FILE, intent);

...
public class SearchAtMemberActivity extends JBaseActivity implements View.OnClickListener {
    ...
    private SearchResult filterInfo(String filterStr) {
        ...
        //所有好友名单
        for (UserInfo friendInfo : BaseConfig.mSearchAtMember) {
        ...
        mLv_searchGroup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (itemAtPosition instanceof UserInfo) {
                    ...
                    intent.putExtra(BaseConfig.SEARCH_AT_MEMBER_NAME, atName);
                    intent.putExtra(BaseConfig.SEARCH_AT_MEMBER_USERNAME, userInfo.getUserName());
                    intent.putExtra(BaseConfig.SEARCH_AT_APPKEY, userInfo.getAppKey());
                    setResult(BaseConfig.SEARCH_AT_MEMBER_CODE, intent);
                    finish();
                }
            }
        });

...
public class GroupNotFriendActivity extends JBaseActivity implements View.OnClickListener {
...
//        dialog.show();
        mUserName = getIntent().getStringExtra(BaseConfig.TARGET_ID);
            ...
            public void gotResult(int responseCode, String responseMessage, UserInfo info) {
                if (responseCode == 0) {
                    ...
                    if (avatar != null) {
                        ...
                        mIv_friendPhoto.setImageResource(R.mipmap.rc_default_portrait);
                    }
        ...
        switch (v.getId()) {
            case R.id.btn_add_friend:
                if (mUserInfo.isFriend()) {
                    ...
                    intent.setClass(GroupNotFriendActivity.this, com.hxd.gobus.chat.activity.VerificationActivity.class);
                    //对方信息
            ...
            case R.id.return_btn:
                ...
                break;
            case R.id.iv_more:
                intent.setClass(GroupNotFriendActivity.this, com.hxd.gobus.chat.activity.NotFriendSettingActivity.class);

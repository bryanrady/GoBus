package com.hxd.gobus.chat.pickerimage;
...
import com.hxd.gobus.chat.pickerimage.adapter.PickerPreviewPagerAdapter;
import com.hxd.gobus.chat.pickerimage.model.PhotoInfo;
import com.hxd.gobus.chat.pickerimage.model.PickerContract;
import com.hxd.gobus.chat.pickerimage.utils.BitmapDecoder;
import com.hxd.gobus.chat.pickerimage.utils.Extras;
import com.hxd.gobus.chat.pickerimage.utils.ImageUtil;
import com.hxd.gobus.chat.pickerimage.utils.PickerUtil;
import com.hxd.gobus.chat.pickerimage.utils.RequestCode;
import com.hxd.gobus.chat.pickerimage.view.BaseZoomableImageView;
import com.hxd.gobus.chat.pickerimage.view.ToolBarOptions;
import com.hxd.gobus.chat.pickerimage.view.UIView;
import com.hxd.gobus.chat.utils.ToastUtil;
import com.hxd.gobus.chat.utils.imagepicker.view.ViewPagerFixed;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    private void setTitleIndex(int index) {
        if (totalSize <= 0) {
            ...
            index++;
            setTitle("");
            tv_toolbar_title.setText(index + "/" + totalSize);
        }
    }

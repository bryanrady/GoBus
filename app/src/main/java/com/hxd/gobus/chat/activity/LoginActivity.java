...
import com.hxd.gobus.chat.controller.LoginController;
import com.hxd.gobus.chat.utils.BitmapLoader;
import com.hxd.gobus.chat.utils.ClearWriteEditText;
...
public class LoginActivity extends JBaseActivity implements View.OnClickListener, View.OnFocusChangeListener {
...
//                break;
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        switch (v.getId()) {
            case R.id.login_userName:
                if (hasFocus) {
                    mLogin_userLogo.setImageResource(R.mipmap.login_user_press);
                    mUserLine.setBackgroundColor(getResources().getColor(R.color.line_press));
                } else {
                    mLogin_userLogo.setImageResource(R.mipmap.login_user_normal);
            ...
            case R.id.login_passWord:
                if (hasFocus) {
                    mLogin_pswLogo.setImageResource(R.mipmap.login_psw_press);
                    mPswLine.setBackgroundColor(getResources().getColor(R.color.line_press));
                } else {
                    mLogin_pswLogo.setImageResource(R.mipmap.login_psw_normal);
...
//        });
    ...
    //    mBackground = (RelativeLayout) findViewById(R.id.background);
        ...
        if (bitmap != null) {
            ...
            mDe_login_logo.setImageResource(R.mipmap.no_avatar);
        }

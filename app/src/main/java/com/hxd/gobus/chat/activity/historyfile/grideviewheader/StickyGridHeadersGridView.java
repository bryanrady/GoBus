...
package com.hxd.gobus.chat.activity.historyfile.grideviewheader;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        } else if (adapter instanceof com.hxd.gobus.chat.activity.historyfile.grideviewheader.StickyGridHeadersSimpleAdapter) {
            // Wrap up simple adapter to auto-generate the data we need.
            baseAdapter = new com.hxd.gobus.chat.activity.historyfile.grideviewheader.StickyGridHeadersSimpleAdapterWrapper(
                    (com.hxd.gobus.chat.activity.historyfile.grideviewheader.StickyGridHeadersSimpleAdapter)adapter);
        } else {
            // Wrap up a list adapter so it is an adapter with zero headers.
            baseAdapter = new com.hxd.gobus.chat.activity.historyfile.grideviewheader.StickyGridHeadersListAdapterWrapper(adapter);
        }

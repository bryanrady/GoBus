...
public class FriendSettingActivity extends JBaseActivity implements SlipButton.OnChangedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.setNoteName:
                Intent intent = new Intent(FriendSettingActivity.this, com.hxd.gobus.chat.activity.SetNoteNameActivity.class);

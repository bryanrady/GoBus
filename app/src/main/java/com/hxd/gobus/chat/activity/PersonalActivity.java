...
import com.hxd.gobus.chat.utils.citychoose.view.SelectAddressDialog;
import com.hxd.gobus.chat.utils.citychoose.view.myinterface.SelectAddressInterface;
import com.hxd.gobus.chat.utils.photochoose.ChoosePhoto;
import com.hxd.gobus.chat.utils.photochoose.PhotoUtils;
...
public class PersonalActivity extends JBaseActivity implements SelectAddressInterface, View.OnClickListener {
            ...
            mMyInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                ...
                public void gotResult(int responseCode, String responseMessage, Bitmap avatarBitmap) {
                    if (responseCode == 0) {
                        ...
                        mIv_photo.setImageResource(R.mipmap.rc_default_portrait);
                    }
                }
            });
            dialog.dismiss();

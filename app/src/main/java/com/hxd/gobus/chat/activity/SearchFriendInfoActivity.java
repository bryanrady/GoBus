...
public class SearchFriendInfoActivity extends JBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_addFriend:
                //添加好友界面
                intent = new Intent(SearchFriendInfoActivity.this, com.hxd.gobus.chat.activity.VerificationActivity.class);

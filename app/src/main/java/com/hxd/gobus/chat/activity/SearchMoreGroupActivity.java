...
import com.hxd.gobus.chat.adapter.SearchGroupListAdapter;
...
public class SearchMoreGroupActivity extends JBaseActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectObject instanceof GroupInfo) {
                    ...
                    if (isForwardMsg) {
                        ...
                        intent.putExtra(BaseConfig.MEMBERS_COUNT, groupInfo.getGroupMembers().size());

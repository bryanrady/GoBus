...
import com.hxd.gobus.chat.view.MyImageView;
...
public class ImageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.mipmap.jmui_picture_not_found)
                .showImageForEmptyUri(R.mipmap.jmui_picture_not_found)
                .showImageOnFail(R.mipmap.jmui_picture_not_found)

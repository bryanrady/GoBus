...
public class DialogCreator {
    ...
    public static Dialog createBaseCustomDialog(Context context,String text, View.OnClickListener onClickListener) {
        ...
        TextView textTv = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_dialog_base_title_tv"));
        Button confirmBtn = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        textTv.setText(text);
    ...
    public static Dialog createDelConversationDialog(Context context,View.OnClickListener listener, boolean isTop) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
    ...
    public static Dialog createSavePictureDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        View v = LayoutInflater.from(context).inflate(
                IdHelper.getLayout(context, "jmui_dialog_delete_conv"), null);
        dialog.setContentView(v);
    ...
    public static Dialog createLongPressMessageDialog(Context context, String title, boolean hide, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
    ...
    public static Dialog createDownloadMessageDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(v);
        TextView title = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_title"));
        title.setText("此文件已经存在，是否需要重新下载？");
        final Button cancel = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_cancel_btn"));
        final Button commit = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        commit.setText("重新下载");
        cancel.setText("打开本地文件");
        cancel.setOnClickListener(listener);
        commit.setOnClickListener(listener);
        dialog.setCancelable(true);
        dialog.setCanceledOnTouchOutside(true);
    ...
    public static Dialog createSureCommitMessageDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(v);
        TextView title = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_title"));
        title.setText("考勤组打卡次数、打卡时间修改可能会引起今日已打卡数据异常，是否确认提交？");
        final Button cancel = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_cancel_btn"));
        final Button commit = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        commit.setText("确定");
        cancel.setText("取消");
    ...
    public static Dialog createIsChangeMeetingDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(v);
        TextView title = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_title"));
        title.setText("修改会议可能导致当前会议被取消，您确定想要修改吗？");
        final Button cancel = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_cancel_btn"));
        final Button commit = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        commit.setText("确定");
        cancel.setText("取消");
    ...
    public static Dialog showSureCommitDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(v);
        TextView title = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_title"));
        title.setText("您确定需要法人签字或盖章吗？");
        final Button cancel = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_cancel_btn"));
        final Button commit = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        commit.setText("确定");
        cancel.setText("取消");
    ...
    public static Dialog createIsCancelMeetingDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        LayoutInflater inflater = LayoutInflater.from(context);
        View v = inflater.inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(v);
        TextView title = (TextView) v.findViewById(IdHelper.getViewID(context, "jmui_title"));
        title.setText("您确定取消本次会议吗？");
        final Button cancel = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_cancel_btn"));
        final Button commit = (Button) v.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
        commit.setText("确定");
        cancel.setText("取消");
    ...
    public static Dialog createLogoutDialog(Context context, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        View view = LayoutInflater.from(context).inflate(IdHelper.getLayout(context, "jmui_dialog_base_with_button"), null);
        dialog.setContentView(view);
    ...
    public static Dialog createLoginTimeOutDialog(Context context, String title, View.OnClickListener listener) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        View view = LayoutInflater.from(context).inflate(IdHelper.getLayout(context, "jmui_dialog_with_button_one"), null);
        dialog.setContentView(view);
        TextView titleTv = (TextView) view.findViewById(IdHelper.getViewID(context, "jmui_title"));
        titleTv.setText(title);
        final Button commit = (Button) view.findViewById(IdHelper.getViewID(context, "jmui_commit_btn"));
...
//                        intent.setClass(context, ResetPasswordActivity.class);
    ...
    public static Dialog createDeleteMemberDialog(Context context, View.OnClickListener listener, boolean isSingle) {
        Dialog dialog = new Dialog(context, IdHelper.getStyle(context, "jmui_default_dialog_style"));
        final LayoutInflater inflater = LayoutInflater.from(context);
    ...
    public static Dialog createBusinessCardDialog(Context context, View.OnClickListener listener, String nameTo, String name, String avatarPath) {
        ...
        if(nameTo.contains(",")){
            String[] split = nameTo.split(",");
            StringBuffer buffer = new StringBuffer();
            for(int i=0;i<split.length;i++){
                if(NumberValidationUtils.isNumeric(split[i])){
                    String nameByWorkNo = SqliteUtils.getNameByWorkNo(context, split[i]);
            ...
            if(buffer.length()>0){
                nameTo = buffer.substring(0,buffer.length()-1);
            }
        }

        cardTo.setText("发送给:"+nameTo);
        cardName.setText(name+"的名片");
        if (avatarPath != null) {
    ...
    public static void createForwardMsg(final Context context, int mWidth, final boolean isSingle, final Conversation conv, final GroupInfo groupInfo, String groupName, final UserInfo userInfo) {
        ...
        if (conv != null) {
            if (conv.getType() == ConversationType.single) {
                String username = ((UserInfo) conv.getTargetInfo()).getDisplayName();
                name.setText(SqliteUtils.getNameByWorkNo(context,username));
            } else {
        ...
        final Message message = BaseConfig.forwardMsg.get(0);
        ...
        switch (message.getContentType()) {
            case text:
                ...
                if (text.getStringExtra("businessCard") != null) {
                    ...
                    String addText = message.getContent().getStringExtra("announMessage");
                    if(addText == null || addText.isEmpty()){
                        addText = "";
                    }
                    content.setText(text.getText()+addText);

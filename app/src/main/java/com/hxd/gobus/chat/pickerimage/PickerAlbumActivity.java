...
import com.hxd.gobus.chat.pickerimage.fragment.PickerAlbumFragment;
import com.hxd.gobus.chat.pickerimage.fragment.PickerImageFragment;
import com.hxd.gobus.chat.pickerimage.model.AlbumInfo;
...
import com.hxd.gobus.chat.pickerimage.utils.PickerConfig;
...
public class PickerAlbumActivity extends UIView implements PickerAlbumFragment.OnAlbumItemClickListener,
	...
	//	setTitle(R.string.picker_image_folder);
		setTitle("");
		tv_toolbar_title.setText(R.string.picker_image_folder);
	}
	...
	//	setTitle(info.getAlbumName());
		setTitle("");
		tv_toolbar_title.setText(info.getAlbumName());
		isAlbumPage = false;
	}

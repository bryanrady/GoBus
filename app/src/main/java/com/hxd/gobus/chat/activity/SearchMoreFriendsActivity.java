...
public class SearchMoreFriendsActivity extends JBaseActivity implements AdapterView.OnItemClickListener {
    ...
    private synchronized SearchResult filterInfo(String filterStr) {
        ...
        //所有好友名单
        List<UserInfo> mFriendInfoList = BaseConfig.mFriendInfoList;

...
import com.hxd.gobus.chat.activity.MembersInChatActivity;
...
public class AllMembersAdapter extends BaseAdapter implements AdapterView.OnItemClickListener,
    ...
    private com.hxd.gobus.chat.adapter.CreateGroupAdapter mGroupAdapter;
    ...
    public AllMembersAdapter(MembersInChatActivity context, List<MembersInChatActivity.ItemModel> memberList, boolean isDeleteMode,
                             ...
                             GridView imageSelectedGridView, com.hxd.gobus.chat.adapter.CreateGroupAdapter groupAdapter) {
            ...
            userInfo.getAvatarBitmap(new GetAvatarBitmapCallback() {
                ...
                public void gotResult(int status, String desc, Bitmap bitmap) {
                    if (status == 0) {
                        ...
                        icon.setImageResource(R.mipmap.jmui_head_icon);
                    }
                }
            });
        } else {

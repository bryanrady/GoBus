...
public class ChatDetailView extends LinearLayout {
    ...
    private LinearLayout mLl_moreGroup;
    private TextView mTv_moreGroup;
    ...
    public void initModule() {
        ...
        mIv_groupAvatar = (CircleImageView) findViewById(R.id.iv_groupAvatar);
        ...
        mLl_moreGroup = (LinearLayout) findViewById(R.id.ll_moreGroup);
        mTv_moreGroup = (TextView) findViewById(R.id.tv_moreGroup);
        ...
        tvToolbarTitle.setText(mContext.getString(R.string.chat_detail_title));
    ...
    public String getTextGroupDesc(){
        return mGroupDesc.getText().toString().trim();
    }
    ...
    public void isLoadMoreShow(boolean isLoad) {
        if (isLoad) {
            mLl_moreGroup.setVisibility(VISIBLE);
        } else {
            mLl_moreGroup.setVisibility(GONE);
        }
    }

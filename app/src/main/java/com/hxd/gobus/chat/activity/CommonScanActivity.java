...
import com.hxd.gobus.chat.model.Constant;
import com.hxd.gobus.chat.model.InfoModel;
import com.hxd.gobus.chat.model.User;
import com.hxd.gobus.chat.model.UserModel;
import com.hxd.gobus.chat.utils.HandleResponseCode;
import com.hxd.gobus.chat.utils.dialog.LoadDialog;
import com.hxd.gobus.chat.utils.zxing.ScanListener;
import com.hxd.gobus.chat.utils.zxing.ScanManager;
import com.hxd.gobus.chat.utils.zxing.decode.DecodeThread;
import com.hxd.gobus.chat.utils.zxing.decode.Utils;
...
public final class CommonScanActivity extends Activity implements ScanListener, View.OnClickListener {
    ...
    public void scanResult(Result rawResult, Bundle bundle) {
        ...
        if (jsonUser.startsWith("http")) {
                    ...
                    public void gotResult(int i, String s, UserInfo userInfo) {
                        ...
                        if (i == 0) {
                            ...
                            if (userInfo.getUserName().equals(JMessageClient.getMyInfo().getUserName())) {
                                intent.setClass(CommonScanActivity.this, com.hxd.gobus.chat.activity.PersonalActivity.class);
                                //扫出来的是好友
                            } else if (userInfo.isFriend()) {
                                intent.setClass(CommonScanActivity.this, com.hxd.gobus.chat.activity.FriendInfoActivity.class);
                                ...
                                intent.setClass(CommonScanActivity.this, com.hxd.gobus.chat.activity.SearchFriendInfoActivity.class);
                            }
                            startActivity(intent);
                            finish();
                        } else {
            ...
            Intent intent = new Intent(CommonScanActivity.this, com.hxd.gobus.chat.activity.ScanResultActivity.class);

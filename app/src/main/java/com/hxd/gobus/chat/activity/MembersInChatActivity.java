...
import com.hxd.gobus.chat.adapter.AllMembersAdapter;
...
public class MembersInChatActivity extends JBaseActivity {
...
//        mSideBar.setTextView(mLetterHintTv);
        ...
        mIsDeleteMode = getIntent().getBooleanExtra(BaseConfig.DELETE_MODE, false);

...
public class VehicleRecordRecyclerAdapter extends RecyclerView.Adapter<VehicleRecordRecyclerAdapter.ViewHolder>
    ...
    public VehicleRecordRecyclerAdapter(Context context, List<Vehicle> list){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.recycler_vehicle_record_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.mTvLicense.setText(mList.get(position).getCarNumber());
        ...
        viewHolder.mTvGetcarStatus.setText(mList.get(position).getUseCarStatusName());
    ...
    public interface OnSlidingViewClickListener {
        void onItemClick(View view, int position, Vehicle vehicle);
        void onItemDeleteClick(View view, int position, Vehicle vehicle);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mTvLicense = slideRecyclerItemView.findViewById(R.id.tv_vehicle_record_item_license);
            mTvApplyDate = slideRecyclerItemView.findViewById(R.id.tv_vehicle_record_item_apply_date);
            mTvGetcarStatus = slideRecyclerItemView.findViewById(R.id.tv_vehicle_record_item_get_car_status);
            mIvApprovalStatus = slideRecyclerItemView.findViewById(R.id.iv_vehicle_record_item_approval_status);
            ...
            ((SideSlipMenuItemView)itemView).setOnSlidingLayoutListener(VehicleRecordRecyclerAdapter.this);
        }
    }
}

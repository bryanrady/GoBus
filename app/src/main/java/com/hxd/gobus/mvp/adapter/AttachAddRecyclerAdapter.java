...
public class AttachAddRecyclerAdapter extends RecyclerView.Adapter<AttachAddRecyclerAdapter.ViewHolder> {

    private Context mContext;
    private List<Attach> mList;
    private OnItemClickListener mListener;

    public AttachAddRecyclerAdapter(Context context, List<Attach> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.recycler_attach_add_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        if (position < mList.size()){
            ...
            holder.iv_delete_attach.setVisibility(View.VISIBLE);
                ...
                if ("doc".equals(fileSuffix) || "docx".equals(fileSuffix)){         //word
                    ...
                    if (!TextUtils.isEmpty(mList.get(position).getNativePath())){
                        ...
                        //        .load("http://192.168.19.34:9999/xuni/"+attachAddress)
                                ...
                                .centerCrop()
                                .into(holder.iv_attach);
                    //    Glide.with(mContext).load(Constant.ATTACH_PICTURE_DOWNLOAD_URL+attachAddress).into(holder.iv_attach);
                    }
                }else{
            ...
            holder.iv_delete_attach.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(mListener != null){
                        mListener.onItemDelete(position,mList.get(position));
                    }
                }
            });
            ...
            holder.rl_attach_shadow.setVisibility(View.GONE);
            holder.iv_delete_attach.setVisibility(View.GONE);

            holder.iv_attach.setBackgroundResource(R.mipmap.ic_add_attach); //add
    ...
    public interface OnItemClickListener{
        void onItemDelete(int position, Attach item);
        void onItemAdd();
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            iv_delete_attach = itemView.findViewById(R.id.iv_delete_attach);

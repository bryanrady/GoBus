 ...
 */
@ActivityScope
public class VehicleApplyModel extends BaseModel implements IVehicleApplyContract.Model {

    @Inject
    public VehicleApplyModel(){
    ...
    @Override
    public Observable<String> queryRequiredData() {
        return RxRetrofitClient
                .create()
                .url(Constant.QUERY_USE_CAR_SYSTEM_CODE_VALUE)
                .raw(HttpParamsManager.getBaseParams(new JSONObject()).toString())
    ...
    @Override
    public Observable<String> addVehicleApply(Vehicle vehicle) {
        return RxRetrofitClient
                .create()
                .url(Constant.ADD_USE_CAR)
                .raw(HttpParamsManager.getBaseParams(VehicleParamsManager.addVehicleApplyParams(vehicle)).toString())
                .build()
                .postRaw()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    ...
    @Override
    public Observable<String> updateVehicleApply(Vehicle vehicle) {
        return RxRetrofitClient
                .create()
    ...
    @Override
    public Observable<String> queryVehicleApplyDetail(int managementId) {
        return RxRetrofitClient
                .create()

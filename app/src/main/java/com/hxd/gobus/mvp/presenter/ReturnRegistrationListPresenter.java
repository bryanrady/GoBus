...
import com.hxd.gobus.mvp.model.ReturnRegistrationListModel;
 ...
 */
@ActivityScope
public class ReturnRegistrationListPresenter extends BasePresenter<IReturnRegistrationListContract.View, ReturnRegistrationListModel> {
    ...
    @Inject
    public ReturnRegistrationListPresenter() {
        if (mList == null){
            mList = new ArrayList<>();
        }
    }
    ...
    public void getNewData(){
        mPageNumber = 1;
        getModel().getReturnRegistrationList(mPageNumber,mPageSize).subscribe(new ObserverImpl() {

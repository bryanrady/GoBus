 ...
 */
@ActivityScope
public class VehicleRegistrationDetailPresenter extends BasePresenter<IVehicleRegistrationDetailContract.View,VehicleRegistrationDetailModel> {

    private List<Attach> mAttachList;

    @Inject
    public VehicleRegistrationDetailPresenter() {

 ...
 */
@ActivityScope
public class RepairApprovalModel extends BaseModel implements IRepairApprovalContract.Model {

    @Inject
    public RepairApprovalModel(){
    ...
    @Override
    public Observable<String> queryRepairApprovalData(Integer datumDataId, String datumType) {
        return RxRetrofitClient
                .create()
                .url(Constant.QUERY_REPAIR_CAR_APPROVAL)
                .raw(HttpParamsManager.getBaseParams(
                        RepairParamsManager.queryRepairApprovalParams(datumDataId, datumType)).toString())
                .build()
                .postRaw()

...
public class DialogListAdapter extends ArrayAdapter<StringInfo>{
    ...
    public DialogListAdapter(Context context, List<StringInfo> list){
        super(context, R.layout.dialog_listview_item, list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = this.inflater.inflate(R.layout.dialog_listview_item, null);

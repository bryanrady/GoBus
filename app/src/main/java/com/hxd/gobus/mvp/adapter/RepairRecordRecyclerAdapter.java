...
public class RepairRecordRecyclerAdapter extends RecyclerView.Adapter<RepairRecordRecyclerAdapter.ViewHolder>
    ...
    public RepairRecordRecyclerAdapter(Context context, List<Repair> list){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.recycler_repair_record_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.mTvGetcarStatus.setText(mList.get(position).getRepairStatusName());
        ...
        if (approvalStatus != null){
            if("0".equals(approvalStatus)){
                ...
                if ("0".equals(mList.get(position).getRepairStatus())){
    ...
    public interface OnSlidingViewClickListener {
        void onItemClick(View view, int position, Repair repair);
        void onItemDeleteClick(View view, int position, Repair repair);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mTvLicense = slideRecyclerItemView.findViewById(R.id.tv_repair_record_item_license);
            mTvApplyDate = slideRecyclerItemView.findViewById(R.id.tv_repair_record_item_apply_date);
            mTvGetcarStatus = slideRecyclerItemView.findViewById(R.id.tv_repair_record_item_get_car_status);
            mIvApprovalStatus = slideRecyclerItemView.findViewById(R.id.iv_repair_record_item_approval_status);
            ...
            ((SideSlipMenuItemView)itemView).setOnSlidingLayoutListener(RepairRecordRecyclerAdapter.this);
        }
    }
}
